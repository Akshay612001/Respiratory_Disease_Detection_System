		...
		<div class="col-md-3 col-vlg-3 col-sm-6">
			<div class="tiles green m-b-10">
			  ...
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title text-black">Overall Vaccination </div>
			         <div class="widget-stats">
                      <div class="wrapper transparent"> 
                      <?php $ov=mysqli_query($con,"select * from usercheck");
					  $num=mysqli_num_rows($ov);
					  ?>
						<span class="item-title">Overall Vaccination</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $num;?>" data-animation-duration="700">0</span>
					  </div>
                    </div>
			  ...
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title text-black"></div>
			         <div class="widget-stats">
					  ...
					  ?>
						<span class="item-title">Overall Bed</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $oq?>" data-animation-duration="700">0</span>
					  </div>
                    </div>
                    <div class="widget-stats">
                      <div class="wrapper transparent">
					  ...
					  ?>
						<span class="item-title"></span> <span class="item-count animate-number semi-bold" data-value="<?php echo $oq1;?>" data-animation-duration="700">0</span> 
					  </div>
                    </div>
                    <div class="widget-stats ">
                      <div class="wrapper last"> 
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
								...
								$('#container').highcharts({
									title: {
										text: 'Daily Vaccination Chart of ' + n,
										x: -20 //center
									},
									subtitle: {
										text: '',
