            ...
            <div class="tiles purple added-margin">
              <div class="tiles-body">
                ...
                <div class="row-fluid">
                  ...
                  <a href="create-ticket.php" style="color:#FFF">Covid Prediction </a>
                   </div>

				<div class="row-fluid">
                  <div class="heading"> <span class="fa fa-ticket"></span>
                  <a href="create-ticket1.php" style="color:#FFF">Asthma Input</a>
                   </div>
	
				<div class="row-fluid">
                  <div class="heading"> <span class="fa fa-ticket"></span>
                  <a href="create-ticket2.php" style="color:#FFF">Asthma Prediction</a>
                   </div>
